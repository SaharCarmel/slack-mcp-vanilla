      ...
      try {
        switch (request.params.name) {
          case 'slack_list_channels': {
            const { limit = 100, cursor } = request.params.arguments as any;
            ...
            if (CHANNEL_IDS?.length) {
              channels = channels.filter(channel => CHANNEL_IDS.includes(channel.id as string));
            }
          ...
          case 'slack_post_message': {
            const { channel_id, text } = request.params.arguments as any;
          ...
          case 'slack_reply_to_thread': {
            const { channel_id, thread_ts, text } = request.params.arguments as any;
            const result = await this.slack.chat.postMessage({
              channel: channel_id,
              thread_ts,
              text,
          ...
          case 'slack_add_reaction': {
            const { channel_id, timestamp, reaction } = request.params.arguments as any;
          ...
          case 'slack_get_channel_history': {
            const { channel_id, limit = 10 } = request.params.arguments as any;
          ...
          case 'slack_get_thread_replies': {
            const { channel_id, thread_ts } = request.params.arguments as any;
          ...
          case 'slack_get_users': {
            const { cursor, limit = 100 } = request.params.arguments as any;
          ...
          case 'slack_get_user_profile': {
            const { user_id } = request.params.arguments as any;
